...
<html>
<head>
    <meta content="GZU-IT教育系统" name="keywords"/>
    <meta content="GZU-IT教育系统" name="description"/>
...
<form id="form1">
        ...
        <div class="header_nav">
            <nav>
                <ul id="showMainNav" class="fix">
                    ...
                    <li class="navContent">
                        <a href="#" class="showNav" id="class" data-name="main_iframe"
                           onclick="Common.switchNavigation(this);"
                           data-url="${pageContext.request.contextPath}/class/manage.do">课程管理</a>
                    </li>

                    <li class="navContent">
                        <a href="#" class="showNav" id="finance" data-name="main_iframe"
                           onclick="Common.switchNavigation(this);"
                           data-url="${pageContext.request.contextPath}/salary/manage.do">资金管理</a>
                    </li>

                    <li class="navContent">
                        <a href="#" class="showNav" id="other" data-name="main_iframe"
                           onclick="Common.switchNavigation(this);"
                           data-url="${pageContext.request.contextPath}/other/manage.do">其他管理</a>
                    </li>
    ...
    <div id="main_iframe"
        ...
        <iframe class="main_iframe" id="home_iframe" frameborder="0"
                border="0" src="${pageContext.request.contextPath}/other/manage.do"></iframe>
    </div>

    <!--====下面是页脚====-->
    <div class="footer">
        <footer>
            <p> 版权所有 @ 2019 GZU-IT教育工作室 </p>
        </footer>
    </div>
</form>
</body>
